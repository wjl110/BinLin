...
//		String fileSpace = "G://imooc_videos_dev";
    ...
    @PostMapping(value = "/userFollow")//用戶跟随//用户的id 用户的关注的id
    public XyfJsonResult userFollow(String userId, String fanId) {
        userService.userFollow(userId, fanId);
        return XyfJsonResult.ok();
    }

    @PostMapping(value = "/userUnFollow")//用戶跟随//用户的id 用户的关注的id
    public XyfJsonResult userUnFollow(String userId, String fanId) {
