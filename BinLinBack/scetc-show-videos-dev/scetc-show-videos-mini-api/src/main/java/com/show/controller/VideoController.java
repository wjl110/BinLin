...
/**
 * 
 * @author 916202420@qq.com 创建时间：2018年6月28日 下午12:07:38
 */
@RestController
@Api(tags = { "视频接口" })
...
public class VideoController extends BasicController {
	...
	@Async
	public void parseFile(String videoPath) {
	...
	@ApiImplicitParams({
			...
			@ApiImplicitParam(name = "videoCategory", value = "视频分类", required = true, dataType = "String", paramType = "query")// 可以不指定
